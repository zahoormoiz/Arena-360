...
export default function Footer() {
    return (
        <footer className="bg-[#111]/90 backdrop-blur-sm text-gray-400 py-10 md:py-12 border-t border-white/5 relative z-20">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="flex gap-3">
                            <Link href="https://www.facebook.com/YourArena360" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-white transition-all">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.791-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                            </Link>
                            <Link href="https://www.instagram.com/yourarena360/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:text-white transition-all">
