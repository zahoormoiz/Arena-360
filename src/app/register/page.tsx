        ...
        <div className="min-h-screen pt-24 pb-12 flex flex-col items-center justify-center px-4 sm:px-6">
            <div className="w-full max-w-md bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 backdrop-blur-xl relative overflow-hidden">
                ...
                <div className="text-center mb-6 sm:mb-8 relative z-10">
                    ...
                    <p className="text-sm text-gray-400">Join Arena360 today</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full h-12 bg-primary text-black font-bold text-sm sm:text-base hover:bg-white hover:scale-[1.02] active:scale-[0.98] transition-all mt-2 disabled:opacity-50 disabled:scale-100"
                    >
